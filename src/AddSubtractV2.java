...
/**
 * Utilizes inner classes to handle events
 * @author danappel
 *
 */

public class AddSubtractV2 extends Application  {
	...
	@Override public void start(Stage primaryStage) {
		...
		btnAdd.setOnAction(ch); //This class will handle all events created here
